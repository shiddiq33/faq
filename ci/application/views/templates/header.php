                    ...
                    <div class="col-12 col-md-4 col-lg-3 dx-feature-variable">
                        ...
                        <div class="dx-feature dx-feature-3 dx-feature-color-1 dx-block-decorated">
                            ...
                            <div class="dx-feature-cont">
                                ...
                                <div class="dx-feature-text">Phasellus interdum est diam, eu varius odio tincidunt eget
                                    ultrices et</div>
                                <a href="documentations.html" class="dx-btn dx-btn-link d-flex dx-feature-link">Read
                                    More <span class="icon pe-7s-angle-right"></span></a>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-md-4 col-lg-3 dx-feature-variable">
                        <div class="dx-feature dx-feature-3 dx-feature-color-2 dx-block-decorated">
                            ...
                            <div class="dx-feature-cont">
                                ...
                                <div class="dx-feature-text">Aliquam id nisi sit amet massa mollis lobortis interdum
                                    felis integer at arcu mattis</div>
                                <a href="articles.html" class="dx-btn dx-btn-link d-flex dx-feature-link">Read More
                    ...
                    <div class="col-12 col-md-4 col-lg-3 dx-feature-variable">
                        ...
                        <div class="dx-feature dx-feature-3 dx-feature-color-3 dx-block-decorated">
                            ...
                            <div class="dx-feature-cont">
                                ...
                                <div class="dx-feature-text">Sed eget nibh justo euismod maximus et vel nisl
                                    pellentesque suscipit nisi</div>
                    ...
                    <div class="col-12 col-md-4 col-lg-3 dx-feature-variable">
                        ...
                        <div class="dx-feature dx-feature-3 dx-feature-color-4 dx-block-decorated">
                            ...
                            <div class="dx-feature-cont">
                                ...
                                <div class="dx-feature-text">Vivamus sceleriue libero velit blandit, hendrerit nisl
                                    at,dapibus sollicitudin</div>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="dx-article dx-article-list">
                                ...
                                <ul class="dx-list">
                                    <li><a href="single-article.html">Make menu dropdown working without JavaScript</a>
                                    </li>
                                    <li><a href="single-article.html">Google Analytics</a></li>
                                    <li><a href="single-article.html">How to manually import Demo data (if you faced
                                            with problems in one-click demo import)</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="swiper-slide">
                        ...
                        <div class="swiper-slide">
                            <div class="dx-article dx-article-list">
                                ...
                                <ul class="dx-list">
                                    <li><a href="single-article.html">Add top menu link inside dropdown on mobile
                                            devices</a></li>
